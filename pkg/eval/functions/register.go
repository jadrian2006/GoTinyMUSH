...
func registerAllInto(ctx *eval.EvalContext) {
	...
	ctx.RegisterFunction("SORTBY", fnSortby, 0, eval.FnVarArgs|eval.FnNoEval)
	...
	ctx.RegisterFunction("MAP", fnMap, 0, eval.FnVarArgs|eval.FnNoEval)
	ctx.RegisterFunction("FILTER", fnFilter, 0, eval.FnVarArgs|eval.FnNoEval)
	ctx.RegisterFunction("FOLD", fnFold, 0, eval.FnVarArgs|eval.FnNoEval)
	ctx.RegisterFunction("FOREACH", fnForeach, 0, eval.FnVarArgs|eval.FnNoEval)
	ctx.RegisterFunctionV("WHILE", fnWhile, 4, 6, eval.FnNoEval)
	...
	ctx.RegisterFunction("STEP", fnStep, 0, eval.FnVarArgs|eval.FnNoEval)
	ctx.RegisterFunction("MIX", fnMix, 0, eval.FnVarArgs|eval.FnNoEval)
	ctx.RegisterFunctionV("MUNGE", fnMunge, 3, 5, 0)
	...
	ctx.RegisterFunction("FILTERBOOL", fnFilterbool, 0, eval.FnVarArgs|eval.FnNoEval)
	ctx.RegisterFunction("UNTIL", fnUntil, 0, eval.FnVarArgs|eval.FnNoEval)

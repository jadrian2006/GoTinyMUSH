...
const (
	...
	aTFail   = 138 // A_TFAIL — teleport (to) fail message
	aOTFail  = 139 // A_OTFAIL — others teleport (to) fail message
	aATFail  = 140 // A_ATFAIL — teleport fail action
	aTOFail  = 141 // A_TOFAIL — teleport (from) fail message
	aOTOFail = 142 // A_OTOFAIL — others teleport (from) fail message
	aATOFail = 143 // A_ATOFAIL — teleport (from) fail action
	aOXTPort = 81  // A_OXTPORT — others teleport message in destination
	aTPort   = 79  // A_TPORT — invoker teleport message
	aOTPort  = 80  // A_OTPORT — others teleport message in source
	aATPort  = 82  // A_ATPORT — teleport action list
	aMove    = 55  // A_MOVE
	aOMove   = 56  // A_OMOVE
	aAMove   = 57  // A_AMOVE
	aOLeave  = 51  // A_OLEAVE
